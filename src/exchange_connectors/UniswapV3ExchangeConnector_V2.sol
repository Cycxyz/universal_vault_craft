...
contract UniswapV3UsdtDaiSusdsExchangeConnector is CommonExchangeConnector, IUniswapV3SwapCallback {
        ...
        returns (uint256 amountIn)
    {
        ...
        (int256 amount0Delta, int256 amount1Delta) = pool.swap(
            msg.sender, zeroForOne, -int256(amountOut), zeroForOne ? MIN_SQRT_RATIO + 1 : MAX_SQRT_RATIO - 1, ""
        );
